...
Технічно — це просто JSON-RPC 2.0. Два транспорти: stdio для локальних процесів і Streamable HTTP для віддалених серверів.
-->
...
<!--
До MCP кожна пара "інструмент + клієнт" потребувала окремої інтеграції. Якщо у вас 10 інструментів і 10 клієнтів — це 100 з'єднань. MCP зводить це до 20.
-->
...
<!--
За 17 місяців — від 50 серверів до тисячі офіційних і незліченної кількості приватних. Від менше мільйона завантажень до 150 мільйонів на місяць.
-->
...
<!--
Ринок вже оцінюється в понад 10 мільярдів доларів із темпом зростання 35% на рік.
-->
...
<div class="mt-8 space-y-3">
  <div class="p-3 bg-gray-800/60 rounded-lg flex items-center gap-3">
    <div class="text-blue-400 font-mono text-sm">tool_calls</div>
    <div class="flex-1 bg-blue-500/20 h-2 rounded"><div class="bg-blue-500 h-2 rounded w-3/4"></div></div>
  </div>
  <div class="p-3 bg-gray-800/60 rounded-lg flex items-center gap-3">
    <div class="text-teal-400 font-mono text-sm">tokens_used</div>
    <div class="flex-1 bg-teal-500/20 h-2 rounded"><div class="bg-teal-500 h-2 rounded w-1/2"></div></div>
  </div>
  <div class="p-3 bg-gray-800/60 rounded-lg flex items-center gap-3">
    <div class="text-purple-400 font-mono text-sm">latency_p95</div>
    <div class="flex-1 bg-purple-500/20 h-2 rounded"><div class="bg-purple-500 h-2 rounded w-2/3"></div></div>
  </div>
  <div class="p-3 bg-gray-800/60 rounded-lg flex items-center gap-3">
    <div class="text-green-400 font-mono text-sm">audit_trail</div>
    <div class="flex-1 bg-green-500/20 h-2 rounded"><div class="bg-green-500 h-2 rounded w-full"></div></div>
  </div>
</div>
